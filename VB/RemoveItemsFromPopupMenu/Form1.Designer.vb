...
'ORIGINAL LINE: this.pdfViewer1.PopupMenuShowing += new DevExpress.XtraPdfViewer.PdfPopupMenuShowingEventHandler(this.pdfViewer1_PopupMenuShowing);
			' 
			' barManager1
			' 
			...
			Me.pdfCommandBar1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {
				...
				New DevExpress.XtraBars.LinkPersistInfo(Me.pdfExportFormDataBarItem1),
				New DevExpress.XtraBars.LinkPersistInfo(Me.pdfImportFormDataBarItem1)
			})
			' 
			' pdfFileOpenBarItem1
			' 
